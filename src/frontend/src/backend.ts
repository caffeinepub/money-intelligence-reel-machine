...
export class Backend implements backendInterface {
    ...
    async cleanAndFormatContent(arg0: Array<string>): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.cleanAndFormatContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async generateScript(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getRecentScripts(): Promise<Array<[Time, Array<string>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentScripts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
